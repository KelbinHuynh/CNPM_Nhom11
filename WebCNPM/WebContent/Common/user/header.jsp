		...
		<div class="header_nav_container">
			<div class="grid wide">
				<div class="row">
					...
					<div class="l-6 hide-on-tablet-moblie">
						<ul class="header_nav_container--list">
							<li><a href="${pageContext.request.contextPath}/">Home</a></li>
							<c:if test="${account.role == 3}">
								<li><a href="${pageContext.request.contextPath}/shipper/shipdeliver">Giao hàng</a></li>
							</c:if>
							<li><a href="${pageContext.request.contextPath}/cart">Giỏ
									hàng</a></li>
							<li><a
								href="${pageContext.request.contextPath}/user/information">Trang
									cá nhân</a></li>
						</ul>
					</div>
					<div class="l-4 m-6 c-4 mb-8">
						<i class="fa-solid fa-bars list-tablet-mobile" id="menu_open"></i>
						<form action>
							<div class="header_nav_container--search">
