					...
					<table class="table table-hover footable-loaded footable">
						<tbody>
							...
							<tr>
								...
								<td colspan="2">
									<c:if test="${project.team.student.size() == null or project.team.student.size() == 1}">
										...
										<button id="back" type="button"
											...
											onclick="location.href='${pageContext.request.contextPath}'">Quay về</button>
									</c:if>
									<c:if test="${project.team.student.size() == 2}">
										<button id="back" type="button"
